    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
         ...
         <form role="form" method="post" action="{{url('guestPurchaseList')}}">
         {{ csrf_field() }}
          <div class="form-group">
          <p><small>Not a member? <a href="#">Sign Up</a></small></p>
         <div style="padding-top: 4px"><button type="submit" name="submit" value="submit" class="btn btn-default btn-success btn-block"> Continue as a Guest </button></div>
         <p class="text-centerd"><small>You'll have the option to register for an account after your purchase.</small></p>
         </div>
         </form>
        </div>
      </div>
