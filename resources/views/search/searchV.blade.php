                        ...
                        <div class="container " style="bor.der: 2px solid red">
                                <div class="row">
                                    <div class="col-md-6 col-sm-6"style="bor.der: 2px solid black; width: 70%;">
                                     <form method="GET", action="searchV" , role = "search">  
                                ...
                                <div class="col-md-7 col-sm-8" >
                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            <li>
                                                ...
                                                @forelse ($searchVideos as $searchVideo)
                                                     <h4 class="search-title">
                                                        <a href="{{url('detailVideo')}}/{{ $searchVideo->id }}"> {{ $searchVideo->title }} <em>(Mp4)</em></a>
                                                    </h4>
                                                    <h5 class="info">{{ $searchVideo->subTitle }}</h5>
                                                    <p class="Authors"> {{ $searchVideo->author }}</p>
                                                  </li>  
                                                   <br><br>
                                                   @empty
