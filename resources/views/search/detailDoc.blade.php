...
@section ('content')
                            ...
                            <div class="col-md-4 col-sm-3">
                                ...
                                <div class="col-md-7 col-sm-8" >
                                                ...
                                                <img  src="{{url('assets/images/doc.png')}}" alt="Educare Document" class="img-responsive center-block">

                                                <button type="button" class="btn btn-success btn-block " id="myBtn" data-toggle="modal" data-target="#myModal">PURCHASE DOCUMENT</button>
                        ...
                        <a href="{{url('detailDoc')}}"> {{$searchDetail->title}} <em> (Doc) </em></a>
                                                    </h4>
