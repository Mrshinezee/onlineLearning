...
@section ('content')
                            ...
                            <div class="col-md-4 col-sm-3">
                                ...
                                <div class="col-md-7 col-sm-8" >
                                                ...
                                                <img  src="{{url('assets/images/avi.png')}}" alt="Educare Document" class="img-responsive center-block">

                                                <button type="button" class="btn btn-success btn-block " id="myBtn" data-toggle="modal" data-target="#myModal"> PURCHASE VIDEO </button>

                                                     <h4 class="search-title text-center text-uppercase">
                                                        <a href="{{url('detailVideo')}}"> {{$searchDetail->title}} <em> (Mp4) </em></a>
                                                    </h4>
