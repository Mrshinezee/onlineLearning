                        ...
                        <div class="container " style="bor.der: 2px solid red">
                                <div class="row">
                                    <div class="col-md-6 col-sm-6"style="bor.der: 2px solid black; width: 70%;">
                                     <form method="GET", action="searchA" , role = "search">  
                                                ...
                                                <div class="search-content">
                                                    ...
                                                    @forelse ($searchAudios as $searchAudio)
                                                     <h4 class="search-title">
                                                        <a href="{{url('detailAudio')}}/{{ $searchAudio->id }}"> {{ $searchAudio->title }} <em>(mp3)</em></a>
                                                    </h4>
                                                    <h5 class="info">{{ $searchAudio->subTitle }}</h5>
                                                    <p class="Authors"> {{ $searchAudio->author }}</p>
                                                  </li>  
                                                   <br><br>
                                                   @empty
